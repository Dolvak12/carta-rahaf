...
أعلم أن الحياة أحيانًا تكون صعبة، لكني أريد أن أذكّركِ كم أنتِ رائعة.

أحبك كثيرًا وأقدّرك من كل قلبي. ليس لديكِ فكرة عن كم أشتاق إليكِ.

أنتِ أجمل ما في حياتي.

صنعتُ هذا لأذكّركِ أني هنا دائمًا من أجلكِ، ولأرسم ابتسامة على وجهكِ، لأنكِ تستحقين كل شيء جميل في هذه الدنيا.

أرسل لكِ أحضاني الدافئة.

مع كل حبي،
Diego`,
    poemText:
        `أحبكِ جدًا جدًا.. فوق الوصف، فوق الغيم، فوق حدود الحكاية
        أحبكِ كأن الحب خُلق لي ولكِ وحدنا في هذا العالم
        أحبكِ بكل اللغات، بكل الصمت، بكل ما فيَّ من نبض وحياة
        ..

        وأنتِ بعيدة.. كم أشتاق إليكِ
        أشتاق إليكِ كأن الشوق بحر بلا شاطئ
        أشتاق إليكِ كأن المسافة بيننا ألف عام من الحنين
        أشتاق لصوتكِ، لضحكتكِ، ليديكِ الصغيرتين في يديَّ
        أشتاق لكل تفصيلة منكِ، لكل لحظة معكِ
        ..

        كل يوم يمر دون أن أراكِ فيه
        ينقص من عمري قليلاً.. ويضيف إلى حبي لكِ كثيراً
        فالبُعد يوجعني.. والحب يحييني
        وكلما زاد الألم من غيابكِ، زاد يقيني بأنكِ أغلى ما أملك
        ..

        رهف.. يا أجمل اسم نطق به فمي
        ويا أصدق شعور سكن في قلبي
        أحبكِ.. نعم أحبكِ جداً
